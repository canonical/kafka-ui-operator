...
from charm import SERVICE_NAME, KafkaUiOperatorCharm
...
def test_pebble_ready(monkeypatch: pytest.MonkeyPatch):
    ...
    # Arrange:
    ctx = testing.Context(KafkaUiOperatorCharm)
    ...
    monkeypatch.setattr("charm.kafka_ui.get_version", mock_get_version)
